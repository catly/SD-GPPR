...
from mycode.MethodBertComp import GraphBertConfig
from mycode.MethodGraphBertNodeClassification import MethodGraphBertNodeClassification
from mycode.MethodGraphBertGraphClustering import MethodGraphBertGraphClustering
...
if 1:
    ...
    print('************ Start ************')
    print('GrapBert, dataset: ' + dataset_name + ', residual: ' + residual_type + ', k: ' + str(
        k) + ', hidden dimension: ' + str(hidden_size) + ', hidden layer: ' + str(
        num_hidden_layers) + ', attention head: ' + str(num_attention_heads))
